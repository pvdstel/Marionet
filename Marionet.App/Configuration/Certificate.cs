...
namespace Marionet.App.Configuration
{
    internal static class Certificate
    {
        ...
        {
            string certificateName = $"Marionet Server {Guid.NewGuid().ToString()}";
        ...
        private static Lazy<X509Certificate2> serverCertificate = new Lazy<X509Certificate2>(() =>
        {
        ...
        private static Lazy<X509Certificate2> clientCertificate = new Lazy<X509Certificate2>(() =>
        {
